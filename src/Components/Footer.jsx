...
function Footer() {
  ...
  return (
    <div id="footer" className='flex justify-between items-center max-w-[1160px] relative min-h-[26vh] m-auto pt-[5rem] mb-[5rem] flex-col min-w-[350px]'>
      ...
      <div className='flex items-center text-center justify-center text-[#656565] mt-2 mx-4 sm:text-[14px] text-xs'>
