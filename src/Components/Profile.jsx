...
function Profile() {
  ...
  return (
    <div id="profile" className='flex justify-between items-center max-w-[1160px] mx-auto px-4 relative gap-[4rem] min-h-[400px] h-[80vh] pt-2 '>
      <div className="md:flex md:h-[350px] md:w-[350px] mx-0 my-auto flex-[0.9] hidden">
      ...
      <div className="flex justify-between flex-col flex-1 content-center self-center mx-0 my-auto">
        ...
        <div className="flex justify-center mt-[1rem] gap-[1rem]">
          <a href="http://www.linkedin.com/in/danielhenriquebelle/" target="_blank" rel="noopener noreferrer">
            <img src={LinkedIn} alt="Meu perfil do LinkedIn" className="cursor-pointer h-[2rem]" />
          </a>
          <a href="https://github.com/danielbelle" target="_blank" rel="noopener noreferrer">
            <img src={GitHub} alt="Meu perfil do GitHub" className="cursor-pointer h-[2rem]" />
          </a>
